...
namespace Lan\DataTypes\RequestResult\Error\CheckIp;

use Lan\Contracts\DataTypes\RequestResult\RequestResultInterface;
use Lan\DataTypes\RequestResult\HttpResult;

class IpNotFound extends HttpResult implements RequestResultInterface
{
    private const MESSAGE = 'Ip не найден';
