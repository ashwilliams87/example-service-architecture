...
namespace Lan\DataTypes\RequestResult\Error\LogOut;

use Lan\Contracts\DataTypes\RequestResult\RequestResultInterface;
use Lan\DataTypes\RequestResult\HttpResult;

class LogOutError extends HttpResult implements RequestResultInterface
{
    private const MESSAGE = 'Разлогин приложения прошел с ошибкой!';
