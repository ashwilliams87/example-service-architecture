...
use Lan\Transformers\Journal\ArticleListTransformer;

class ArticleListResponseDTO extends ListDTO implements MobileListDTOInterface, CreatableFromArrayList
{
    protected function __construct(ArticleCardDTO...$dtoCollection)
    {
        parent::__construct(...$dtoCollection);
    }

    public function toMobileScheme(TransformMobile $transformer = new ArticleListTransformer()): array
    {
