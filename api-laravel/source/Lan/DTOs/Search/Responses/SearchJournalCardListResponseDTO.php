...
use Lan\Transformers\Search\SearchJournalCardListTransformer;


class SearchJournalCardListResponseDTO extends ListDTO implements MobileListDTOInterface, CreatableFromArrayList
{
    public function toMobileScheme(TransformMobile $transformer = new SearchJournalCardListTransformer()): array
    {
        return $transformer->transformToMobileScheme($this);
    }

    protected function __construct(SearchJournalCardDTO...$dtoCollection)
    {
    ...
    {
        return SearchJournalCardDTO::class;
    }
