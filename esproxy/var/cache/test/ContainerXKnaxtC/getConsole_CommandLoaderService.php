...
class getConsole_CommandLoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'fos_elastica.command.create' => ['privates', 'fos_elastica.command.create', 'getFosElastica_Command_CreateService', true],
            'fos_elastica.command.delete' => ['privates', 'fos_elastica.command.delete', 'getFosElastica_Command_DeleteService', true],
            'fos_elastica.command.populate' => ['privates', 'fos_elastica.command.populate', 'getFosElastica_Command_PopulateService', true],
            'fos_elastica.command.reset' => ['privates', 'fos_elastica.command.reset', 'getFosElastica_Command_ResetService', true],
            'fos_elastica.command.templates_reset' => ['privates', 'fos_elastica.command.templates_reset', 'getFosElastica_Command_TemplatesResetService', true],
            'fos_elastica.command.search' => ['privates', 'fos_elastica.command.search', 'getFosElastica_Command_SearchService', true],
